...
var RolService = /** @class */ (function () {
    ...
    RolService.prototype.getRole = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connectBD.query("SELECT  \n          r.id_rol AS ID,\n          r.descripcion_rol AS descripcion\n          FROM rol r \n          WHERE r.id_rol = $1\n          AND   r.estado_rol = 1", [id])];
                    case 1:
                        response = _a.sent();
    ...
    RolService.prototype.createRol = function (rol) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connectBD.query("INSERT INTO rol (\n        descripcion_rol,\n        created_on,\n        estado_rol\n      ) \n      VALUES ($1,NOW(),1)", [rol.descripcion])];
                    case 1:
                        response = _a.sent();
    ...
    RolService.prototype.editRol = function (rol) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connectBD.query("UPDATE rol \n        SET  descripcion_rol = $2\n        WHERE id_rol = $1", [rol.id, rol.descripcion])];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.rowCount];
                }
    ...
    RolService.prototype.deleteRol = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.connectBD.query("DELETE FROM rol WHERE id_rol = $1", [id])];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, response.rowCount];
                }
